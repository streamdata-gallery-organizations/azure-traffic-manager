...
- name: Azure Traffic Manager API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-organizations/azure-traffic-manager/master/_listings/azure-traffic-manager/providers-microsoft-network-trafficmanagergeographichierarchies-default-get.md
x-common:
